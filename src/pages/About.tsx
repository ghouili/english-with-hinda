      ...
      <section className="container py-12 max-w-4xl">
        ...
        <ScrollReveal>
          <div className="space-y-4 text-base text-muted-foreground leading-relaxed mb-12">
            <p>
              Passionate about teaching English for over 15 years, Hinda has
              dedicated her career to helping Tunisian students master this
              essential language. Through her classroom experience, she
              identified the critical need for teaching materials adapted to the
              Tunisian context.
            </p>
            <p>
              This is how English With Hinda was born: a collection of books
              designed by and for Tunisian students, from their first contact
              with English in 4th year through to exam success in 9th year.
            </p>
          </div>
        </ScrollReveal>
            ...
            <div className="relative border-l-2 border-primary/20 pl-6 space-y-6">
              {TIMELINE.map((t) => (
                <div key={t.year} className="relative">
                  ...
                  <p className="text-base text-muted-foreground">{t.label}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <ScrollReveal>
          <div className="mb-12">
            ...
            <p className="text-muted-foreground text-base mb-6">
              A progressive approach, contextualized for Tunisian students.
            </p>
        ...
        <ScrollReveal>
          <div className="rounded-xl bg-secondary p-6 sm:p-8 text-center">
            ...
            <p className="text-muted-foreground mb-6">
              Discover the book adapted for each school year.
            </p>
